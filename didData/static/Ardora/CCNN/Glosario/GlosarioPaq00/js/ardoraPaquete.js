...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='';
   menuActividades='<li><h2></h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Enfermedades Comunes\">1</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario01/Glosario01.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario02/Glosario02.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario03/Glosario03.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario04/Glosario04.htm'></object>",false,"",true,false,false);
taboaContidos[4]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario05/Glosario05.htm'></object>",false,"",true,false,false);
taboaContidos[5]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario06/Glosario06.htm'></object>",false,"",true,false,false);
taboaContidos[6]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario07/Glosario07.htm'></object>",false,"",true,false,false);
taboaContidos[7]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario08/Glosario08.htm'></object>",false,"",true,false,false);
taboaContidos[8]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario09/Glosario09.htm'></object>",false,"",true,false,false);
taboaContidos[9]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario10/Glosario10.htm'></object>",false,"",true,false,false);
taboaContidos[10]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario11/Glosario11.htm'></object>",false,"",true,false,false);
taboaContidos[11]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario12/Glosario12.htm'></object>",false,"",true,false,false);
