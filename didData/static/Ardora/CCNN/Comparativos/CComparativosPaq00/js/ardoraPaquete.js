...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuActividades='<li><h2></h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Autotofos Vs Heterotrofos\">1</a></td><td width=\"26\"><a href=\"javascript:irA(1)\" title=\"Procarionte Vs Eucarionte\">2</a></td><td width=\"26\"><a href=\"javascript:irA(2)\" title=\"Comparativo Microorganismos\">3</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Autotofos Vs Heterotrofos","Autotofos Vs Heterotrofos","","<object width='100%' height='420' type='text/html' data='AutotrofosVsHeterotrofos00/AutotrofosVsHeterotrofos00.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Procarionte Vs Eucarionte","Procarionte Vs Eucarionte","","<object width='100%' height='420' type='text/html' data='ProcarionteVsEucarionte00/ProcarionteVsEucarionte00.htm'></object>",true,"",true,true,true);
taboaContidos[2]=new act("Comparativo Microorganismos","Comparativo Microorganismos","","<object width='100%' height='420' type='text/html' data='TresReinos00/TresReinos00.htm'></object>",true,"",true,true,true);
