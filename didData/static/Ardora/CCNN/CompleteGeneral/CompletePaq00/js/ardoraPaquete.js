...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='';
   menuActividades='<li><h2></h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Reino Mónera\">1</a></td><td width=\"26\"><a href=\"javascript:irA(1)\" title=\"Reino Mónera\">2</a></td><td width=\"26\"><a href=\"javascript:irA(2)\" title=\"Reino Protoctista\">3</a></td><td width=\"26\"><a href=\"javascript:irA(3)\" title=\"Reino Protoctista\">4</a></td><td width=\"26\"><a href=\"javascript:irA(4)\" title=\"Reino Protoctista\">5</a></td></tr><tr><td width=\"26\"><a href=\"javascript:irA(5)\" title=\"Reino Fungi\">6</a></td><td width=\"26\"><a href=\"javascript:irA(6)\" title=\"Reino Fungi\">7</a></td><td width=\"26\"><a href=\"javascript:irA(7)\" title=\"Reino Fungi\">8</a></td><td width=\"26\"><a href=\"javascript:irA(8)\" title=\"Reino Fungi\">9</a></td><td width=\"26\"><a href=\"javascript:irA(9)\" title=\"Reino Fungi\">10</a></td></tr><tr><td width=\"26\"><a href=\"javascript:irA(10)\" title=\"Los Virus\">11</a></td><td width=\"26\"><a href=\"javascript:irA(11)\" title=\"Los Virus\">12</a></td><td width=\"26\"><a href=\"javascript:irA(12)\" title=\"Los Virus\">13</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Reino Mónera","Reino Mónera","","<object width='100%' height='420' type='text/html' data='CompleteGeneral01/CompleteGeneral01.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Reino Mónera","Reino Mónera","","<object width='100%' height='420' type='text/html' data='CompleteGeneral02/CompleteGeneral02.htm'></object>",true,"",true,true,true);
taboaContidos[2]=new act("Reino Protoctista","Reino Protoctista","","<object width='100%' height='420' type='text/html' data='CompleteGeneral04/CompleteGeneral04.htm'></object>",true,"",true,true,true);
taboaContidos[3]=new act("Reino Protoctista","Reino Protoctista","","<object width='100%' height='420' type='text/html' data='CompleteGeneral05/CompleteGeneral05.htm'></object>",true,"",true,true,true);
taboaContidos[4]=new act("Reino Protoctista","Reino Protoctista","","<object width='100%' height='420' type='text/html' data='CompleteGeneral06/CompleteGeneral06.htm'></object>",true,"",true,true,true);
taboaContidos[5]=new act("Reino Fungi","Reino Fungi","","<object width='100%' height='420' type='text/html' data='CompleteGeneral07/CompleteGeneral07.htm'></object>",true,"",true,true,true);
taboaContidos[6]=new act("Reino Fungi","Reino Fungi","","<object width='100%' height='420' type='text/html' data='CompleteGeneral08/CompleteGeneral08.htm'></object>",true,"",true,true,true);
taboaContidos[7]=new act("Reino Fungi","Reino Fungi","","<object width='100%' height='420' type='text/html' data='CompleteGeneral09/CompleteGeneral09.htm'></object>",true,"",true,true,true);
taboaContidos[8]=new act("Reino Fungi","Reino Fungi","","<object width='100%' height='420' type='text/html' data='CompleteGeneral10/CompleteGeneral10.htm'></object>",true,"",true,true,true);
taboaContidos[9]=new act("Reino Fungi","Reino Fungi","","<object width='100%' height='420' type='text/html' data='CompleteGeneral11/CompleteGeneral11.htm'></object>",true,"",true,true,true);
taboaContidos[10]=new act("Los Virus","Los Virus","","<object width='100%' height='420' type='text/html' data='CompleteGeneral12/CompleteGeneral12.htm'></object>",true,"",true,true,true);
taboaContidos[11]=new act("Los Virus","Los Virus","","<object width='100%' height='420' type='text/html' data='CompleteGeneral14/CompleteGeneral14.htm'></object>",true,"",true,true,true);
taboaContidos[12]=new act("Los Virus","Los Virus","","<object width='100%' height='420' type='text/html' data='CompleteGeneral15/CompleteGeneral15.htm'></object>",true,"",true,true,true);
