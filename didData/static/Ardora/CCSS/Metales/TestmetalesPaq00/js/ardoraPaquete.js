...
function inicia(){
   ...
   menuLateral='';
   menuActividades='<li><h2></h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Edad de Los Metales\">1</a></td><td width=\"26\"><a href=\"javascript:irA(1)\" title=\"Edad de Los Metales\">2</a></td><td width=\"26\"><a href=\"javascript:irA(2)\" title=\"Edad de Los Metales\">3</a></td><td width=\"26\"><a href=\"javascript:irA(3)\" title=\"Edad de Los Metales\">4</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Edad de Los Metales","Edad de Los Metales","","<object width='100%' height='420' type='text/html' data='TestMetales01/TestMetales01.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Edad de Los Metales","Edad de Los Metales","","<object width='100%' height='420' type='text/html' data='TestMetales02/TestMetales02.htm'></object>",true,"",true,true,true);
taboaContidos[2]=new act("Edad de Los Metales","Edad de Los Metales","","<object width='100%' height='420' type='text/html' data='TestMetales03/TestMetales03.htm'></object>",true,"",true,true,true);
taboaContidos[3]=new act("Edad de Los Metales","Edad de Los Metales","","<object width='100%' height='420' type='text/html' data='TestMetales04/TestMetales04.htm'></object>",true,"",true,true,true);
