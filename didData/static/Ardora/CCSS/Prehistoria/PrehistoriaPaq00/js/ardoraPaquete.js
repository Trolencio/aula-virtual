...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='<li><h2>Soluciones</h2><ul><li><a href=\"file:///C:/Users/Orlando2004/Desktop/SitioArdora/ccss/Prehistoria/EsquemaSolucion/EsquemaSolucion.htm\" target=\"_blank\">Esquema Prehist</a></li><li><a href=\"C:/Users/Orlando2004/Desktop/SitioArdora/ccss/Prehistoria/EtapasPrehistoria03Sol/EtapasPrehistoria03Sol.htm\" target=\"_blank\">Etapas Prehist</a></li></ul></li>';
   menuActividades='<li><h2>Actividades</h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Etapas Prehistoria\">1</a></td><td width=\"26\"><a href=\"javascript:irA(1)\" title=\"Paleolítico\">2</a></td><td width=\"26\"><a href=\"javascript:irA(2)\" title=\"Neolítico\">3</a></td><td width=\"26\"><a href=\"javascript:irA(3)\" title=\"Homínidos\">4</a></td><td width=\"26\"><a href=\"javascript:irA(4)\" title=\"Comparativo Prehistoria\">5</a></td></tr><tr><td width=\"26\"><a href=\"javascript:irA(5)\" title=\"Comparativo Prehistoria\">6</a></td><td width=\"26\"><a href=\"javascript:irA(6)\" title=\"Comparativo Prehistoria\">7</a></td><td width=\"26\"><a href=\"javascript:irA(7)\" title=\"Comparativo Prehistoria\">8</a></td><td width=\"26\"><a href=\"javascript:irA(8)\" title=\"Esquema Prehistoria\">9</a></td><td width=\"26\"><a href=\"javascript:irA(9)\" title=\"Test Paleolítico\">10</a></td></tr><tr><td width=\"26\"><a href=\"javascript:irA(10)\" title=\"Test Neolítico\">11</a></td><td width=\"26\"><a href=\"javascript:irA(11)\" title=\"Test Metales\">12</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Etapas Prehistoria","Etapas Prehistoria","","<object width='100%' height='420' type='text/html' data='EtapasPrehistoria00/EtapasPrehistoria00.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Paleolítico","Paleolítico","","<object width='100%' height='420' type='text/html' data='EtapasPrehistoria01/EtapasPrehistoria01.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Neolítico","Neolítico","","<object width='100%' height='420' type='text/html' data='EtapasPrehistoria02/EtapasPrehistoria02.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Homínidos","Homínidos","","<object width='100%' height='420' type='text/html' data='ComparativoHominidos/ComparativoHominidos.htm'></object>",false,"",true,true,true);
taboaContidos[4]=new act("Comparativo Prehistoria","Comparativo Prehistoria","","<object width='100%' height='420' type='text/html' data='EtapasPrehistoria031/EtapasPrehistoria031.htm'></object>",false,"",true,true,true);
taboaContidos[5]=new act("Comparativo Prehistoria","Comparativo Prehistoria","","<object width='100%' height='420' type='text/html' data='EtapasPrehistoria032/EtapasPrehistoria032.htm'></object>",false,"",true,true,true);
taboaContidos[6]=new act("Comparativo Prehistoria","Comparativo Prehistoria","","<object width='100%' height='420' type='text/html' data='ComparativoPrehistoriaP1/ComparativoPrehistoriaP1.htm'></object>",false,"",true,true,true);
taboaContidos[7]=new act("Comparativo Prehistoria","Comparativo Prehistoria","","<object width='100%' height='420' type='text/html' data='ComparativoPrehistoriaP2/ComparativoPrehistoriaP2.htm'></object>",false,"",true,true,true);
taboaContidos[8]=new act("Esquema Prehistoria","Esquema Prehistoria","","<object width='100%' height='420' type='text/html' data='EsquemaPrehistoria00/EsquemaPrehistoria00.htm'></object>",false,"",true,true,true);
taboaContidos[9]=new act("Test Paleolítico","Test Paleolítico","","<object width='100%' height='420' type='text/html' data='TestPaleolitico00/TestPaleolitico00.htm'></object>",false,"",true,true,true);
taboaContidos[10]=new act("Test Neolítico","Test Neolítico","","<object width='100%' height='420' type='text/html' data='TestNeolitico00/TestNeolitico00.htm'></object>",false,"",true,true,true);
taboaContidos[11]=new act("Test Metales","Test Metales","","<object width='100%' height='420' type='text/html' data='TestMetales01/TestMetales01.htm'></object>",false,"",true,true,true);
