...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='';
   menuActividades='<h2></h2><h4><a href=\"javascript:irA(0)\" title=\"Glosario\">1</a><a href=\"javascript:irA(1)\" title=\"Glosario\">2</a></h4>';
...
taboaContidos[0]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario01/Glosario01.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("Glosario","Glosario","","<object width='100%' height='420' type='text/html' data='Glosario02/Glosario02.htm'></object>",true,"",true,true,true);
