...
window.open("avalia/avalia.htm","width=800,height=600,scrollbars='");
   ...
   menuLateral='';
   menuActividades='<li><h2></h2><table width=\"130\" border=\"0\"><ul><tr><td width=\"26\"><a href=\"javascript:irA(0)\" title=\"Parte 1\">1</a></td><td width=\"26\"><a href=\"javascript:irA(1)\" title=\"Parte 2\">2</a></td><td width=\"26\"><a href=\"javascript:irA(2)\" title=\"Parte 3\">3</a></td></tr></ul></table></li>';
...
taboaContidos[0]=new act("Civilizaciones Fluviales","Civilizaciones Fluviales","","<object width='100%' height='420' type='text/html' data='General01/General01.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Civilizaciones Fluviales","Civilizaciones Fluviales","","<object width='100%' height='420' type='text/html' data='General02/General02.htm'></object>",false,"",true,true,true);
