...
taboaContidos[0]=new act("Mesopotamia","Mesopotamia","","<object width='100%' height='420' type='text/html' data='Mesopotamia01/Mesopotamia01.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Mesopotamia","Mesopotamia","","<object width='100%' height='420' type='text/html' data='Mesopotamia02/Mesopotamia02.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Mesopotamia","Mesopotamia","","<object width='100%' height='420' type='text/html' data='Mesopotamia03/Mesopotamia03.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Mesopotamia","Mesopotamia","","<object width='100%' height='420' type='text/html' data='Mesopotamia04/Mesopotamia04.htm'></object>",false,"",true,true,true);
